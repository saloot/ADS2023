...
* All scores are measured on test set, which should be 20% of the whole dataset
* You can use the [lab sessions's notebook](https://colab.research.google.com/drive/1GlpdwJj9LX_P0EGzh5tyMAL7gVtb-NeT?usp=sharing) as a guideline.
...
* You can use the [lab sessions's notebook](https://colab.research.google.com/drive/1-6xI_DaY_lsMzLXQuPS5Vzj2-t-7O7re?usp=sharing) as a guideline.
...
* You can use the [lab sessions's notebook](https://colab.research.google.com/drive/1QFSgMv4ZhpYlOLMPUMf4lOxtB3fyBDYD?usp=sharing) as a guideline.
...
* You can use the [lab sessions's notebook](https://colab.research.google.com/drive/1BuwW73gEbZgjtuwZn2kQ2UsFwIu7Yt3r?usp=sharing) as a guideline.
